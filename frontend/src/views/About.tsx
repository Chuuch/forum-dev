...
export default function AboutPage() {
  return (
    <>
      <header>
        <title>TheDailyBlock | За нас</title>
      </header>
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 1.5, ease: "easeOut" }}
        className="max-w-5xl w-full mx-auto py-12 px-6 text-gray-300"
      >
        ...
        <div className="flex flex-col justify-start items-start mt-12">
          <h1 className="flex text-primary text-2xl font-semibold w-full py-12 gap-2">
            <FaMasksTheater size={28} />
