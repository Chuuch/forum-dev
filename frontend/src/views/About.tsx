...
export default function AboutPage() {
  return (
    <div className="max-w-3xl w-full mx-auto py-12 px-6 text-gray-300">
      <h1 className="text-4xl font-bold text-teal-400 mb-4">За нас</h1>

      <p className="text-lg mb-6 text-gray-500">
        Добре дошли в{" "}
        <span className="text-teal-500 font-semibold">TheDailyBlock</span> –
      ...
      <ul className="list-disc list-inside space-y-2 text-gray-500">
        <li>
          🔹 <span className="font-bold">Ръководства и уроци</span> за блокчейн
          и Web3 разработка
        </li>
        <li>
