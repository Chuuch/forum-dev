...
export default function Blockchain() {
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto p-6 text-gray-400">
        <h1 className="text-4xl font-bold text-teal-400 mb-6">
          Какво е всъщност Блокчейн?
        </h1>
        <p className="text-lg mb-4">
          Блокчейн е{" "}
          <span className="text-blue-400 font-semibold">децентрализирана</span>{" "}
          и <span className="text-teal-300 font-semibold">разпределена</span>{" "}
          технология, която съхранява информация в последователност от блокове,
          свързани чрез криптографски механизми.
        </p>
        ...
        <ul className="list-disc list-inside space-y-2 mt-4">
          <li>
            <span className="text-blue-300 font-semibold">Децентрализация</span>{" "}
        ...
        <p className="mt-4">
          ...
          <span className="text-blue-400 font-semibold">верига от блокове</span>
        ...
        <h2 className="text-3xl text-sky-400 font-semibold mt-6">Заключение</h2>
        <p className="mt-4">
          Блокчейн е{" "}
          <span className="text-teal-500 font-semibold">
            революционна технология
          </span>
          , която трансформира начина, по който обменяме информация и стойност.
          С нейната помощ можем да изградим по-сигурни, прозрачни и ефективни
          системи.
        </p>
